...
export const getAllCategories = async () => {
  try {
    ...
    console.log("CategoryService - Full API Response:", response);
    ...
    console.log("CategoryService - Is Array?", Array.isArray(response.data));
    if (Array.isArray(response.data)) {
      console.log("CategoryService - Array length:", response.data.length);
      console.log("CategoryService - First item:", response.data[0]);
    }
